  	...
  	<div class="content">
		...
		<table>
			<tr class="head" align="center">
				...
				<td width="150px;">用户手机</td>
				<td width="160px;">电子邮箱</td>
				...
				<c:forEach var="ulist" items="${ulist}">
					<tr align="center">
						...
						<td>${ulist.phone}</td>
						<td>${ulist.email }</td>
						<td><fmt:formatDate value="${ulist.created }" pattern="yyyy-MM-dd" /></td>
						<td>
						<a href="/adm/user/update/${ulist.id }">修改</a>
							<a href="/adm/user/del/${ulist.id }">删除</a>
						</td>
					</tr>
				</c:forEach>
